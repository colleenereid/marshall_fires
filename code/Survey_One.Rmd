...
# table(wave.one.only2$income, wave.two.only1$income)
chisq.test(wave.one.only2$income, wave.two.only1$income)
# table(wave.one.only2$RaceEthn2, wave.two.only1$RaceEthn2)
chisq.test(wave.one.only2$RaceEthn2, wave.two.only1$RaceEthn2)
# table(wave.one.only2$ownership_status, wave.two.only1$renterowner)
chisq.test(wave.one.only2$ownership_status, wave.two.only1$renterowner)
# table(wave.one.only2$impact_cat, wave.two.only1$impact_cat)
chisq.test(wave.one.only2$impact_cat, wave.two.only1$impact_cat)
# table(wave.one.only2$group, wave.two.only1$group)
...
ggarrange(w1.before.neigh.plot,w1.after.neigh.plot, nrow=2, common.legend = T)
```
