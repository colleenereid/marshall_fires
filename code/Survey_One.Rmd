...
```{r}
marshall.sp.aq1 = as(filter(geo_marshall,!is.na(air_quality_1)),"Spatial")
...
ggplot(filter(geo_marshall,!is.na(air_quality_1))) +
  ...
  scale_color_manual(values = c("1" = "#d7191c",
                                ...
                                "4" = "#a6d96a",
                                "5" = "#1a9641")) +
  ggtitle("Marshall Fire Survey Results (NA's filtered out)", subtitle=paste0("Wave One: Total Respondants Displayed: ",nrow(filter(geo_marshall,!is.na(air_quality_1))))) +
  theme(plot.title = element_text(hjust=0.5),
        plot.subtitle = element_text(hjust=0.5)) +
...
```{r}
marshall.sp.aq3 = as(filter(geo_marshall,!is.na(air_quality_3)),"Spatial")
marshall.sp.aq4 = as(filter(geo_marshall,!is.na(air_quality_4)),"Spatial")
...
ggplot(filter(geo_marshall,!is.na(air_quality_3))) +
  ...
  scale_color_manual(values = c("1" = "#d7191c",
                                ...
                                "4" = "#a6d96a",
                                "5" = "#1a9641")) +
  ggtitle("Marshall Fire Survey Results (NA's filtered out) \n Before the Fire", subtitle=paste0("Wave One: Total Respondants Displayed: ",nrow(filter(geo_marshall,!is.na(air_quality_3))))) +
  theme(plot.title = element_text(hjust=0.5),
        plot.subtitle = element_text(hjust=0.5)) +
  guides(colour=guide_legend(title=""))
...
ggplot(filter(geo_marshall,!is.na(air_quality_4))) +
  ...
  scale_color_manual(values = c("1" = "#d7191c",
                                ...
                                "4" = "#a6d96a",
                                "5" = "#1a9641")) +
  ggtitle("Marshall Fire Survey Results (NA's filtered out) \n After the Fire", subtitle=paste0("Wave One: Total Respondants Displayed: ",nrow(filter(geo_marshall,!is.na(air_quality_4))))) +
  theme(plot.title = element_text(hjust=0.5),
        plot.subtitle = element_text(hjust=0.5)) +
  guides(colour=guide_legend(title=""))
```
...
df=cbind(wave2.symptoms,count,rnames) %>% 
  as.data.frame() %>% 
  dplyr::select(rnames,count)
df$count=as.integer(df$count)
colnames(df)=c("Symptom","Count")
final_df = df %>% 
  mutate(Percent=round(Count/nrow(wave.two)*100,2))
knitr::kable(final_df)
```
