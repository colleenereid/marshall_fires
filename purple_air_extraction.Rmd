...
# add more descriptive id - town, outdoor/indoor, neighborhood
...
for (sensor in 1:30) {
  one_sensor <- PA_STFDF[sensor,"2021-12-30::2021-12-31", "pm25_a"]
  p <- ggplot(fortify(one_sensor), aes(x=Index, y=pm25_a)) +
      geom_line() +
      labs(x="date", title = paste("sensor", sensor, "pm2.5"))
  print(p)
  png(file=paste("images/sensor", sensor, "_ts.png"), width=500, height=500)
  print(p)
  dev.off()
}
# stplot(PA_STFDF[1:5,"2021-12-30::2021-12-31", "pm25_a"], mode="ts")
```
