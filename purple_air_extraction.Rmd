...
purpleairDownload(site.csv = fire_area_sensors, start.date = "2021-12-30", end.date = "2022-02-26", output.path = "sensors2/", average = 10, time.zone = "America/Denver", indoor = TRUE, n.thread = 1)
```
...
time_period_classification$status = factor(time_period_classification$status, levels = c("Complete data throughout fire period", "Sensor went offline during fire, (most data) returned online", "Sensor went offline during fire, (most data) did not return online", "Sensor added during fire without much data, (most data) did not return online", "Sensor came online after fire"))
